          ...
          >
            ...
            >
              ...
              <p className="text-xl text-slate-400 leading-relaxed max-w-2xl">
                Shopora connects customers with nearby shops and products while helping local businesses gain visibility, reach, and growth.
              </p>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="flex flex-wrap gap-4 pt-4">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="grid gap-4 grid-cols-1 sm:grid-cols-3 pt-8 border-t border-white/10">
              {stats.map((stat, idx) => (
              ...
              >
                <div className="rounded-2xl bg-slate-900/80 p-6 border border-white/10">
                  ...
                  <div className="space-y-3">
                    <div className="rounded-xl bg-slate-950/50 p-4 flex items-center gap-3">
                    ...
                    <div className="rounded-xl bg-gradient-to-r from-shopora-primary/20 to-shopora-accent/10 p-4 border border-shopora-primary/30 flex items-center gap-3">
                      <span className="text-2xl">🎁</span>
                      <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-xl bg-slate-950/80 p-4 border border-white/10">
                    <p className="text-xs text-slate-500 uppercase">Reach</p>
